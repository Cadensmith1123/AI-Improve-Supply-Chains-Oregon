...
def test_04_vehicles(connection, features_dict, schema_types):
    ...
    new_id = create.add_vehicle(
        ...
        purchase_price=generate_random_value(cols['vehicle_purchase_price']),
        yearly_mileage=generate_random_value(cols['vehicle_estimated_yearly_milage']),
        salvage_value=generate_random_value(cols['vehicle_estimated_salvage_value']),
