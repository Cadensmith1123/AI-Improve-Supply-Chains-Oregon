...
BEGIN
    ...
    SET
        name = p_name,
        mpg = p_mpg,
        vehicle_purchase_price = p_purchase_price,
        vehicle_estimated_yearly_milage = p_yearly_mileage,
        vehicle_estimated_salvage_value = p_salvage_value,
...
CREATE PROCEDURE update_scenario(
    ...
    IN p_snapshot_depreciation_per_mile DECIMAL(5, 3),
...
BEGIN
    ...
    SET
        ...
        snapshot_depreciation_per_mile = p_snapshot_depreciation_per_mile,
        snapshot_daily_insurance = p_snapshot_daily_insurance,
        snapshot_daily_maintenance_cost = p_snapshot_daily_maintenance_cost,
